...
def upgrade() -> None:
    ...
    op.alter_column(
        "voice_tweets", "caption", existing_type=sa.String(length=280), type_=sa.String(length=500), nullable=True
    )


def downgrade() -> None:
    op.alter_column(
        "voice_tweets", "caption", existing_type=sa.String(length=500), type_=sa.String(length=280), nullable=True
    )
